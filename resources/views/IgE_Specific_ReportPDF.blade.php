...
@if($MegaTestID->test_comment)
<div>
<label style="font-weight:bold;float:left;text-decoration:underline">Interpretation</label>
</div>
<br>
<div>
{!! nl2br(e($MegaTestID->test_comment)) !!}
</div>
@endif
