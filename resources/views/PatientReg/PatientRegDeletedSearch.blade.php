...
<html>
<head>
<title>LabTech Software (Deleted Patients Search)</title>
<style>   
Body {  
  font-family:  serif;  
...
<input type="text" name="patient_id" value="{{ (request()->input('patient_id',old('patient_id'))?:'') }}">

<th>{{__('title.visitno_reg')}}</th>
<input type="number" min="1" step="1" name="visit_no" value="{{ (request()->input('visit_no',old('visit_no'))?:'') }}">
<th>{{__('title.patientname_reg')}}</th>
<input type="text" name="patient_name" value="{{ (request()->input('patient_name',old('patient_name'))?:'') }}">
<th>{{__('title.reqdatefrom_reg')}}</th>
<input type="datetime" name="datefrom" value="{{ (request()->input('datefrom',old('datefrom'))?:'') }}">
<th>{{__('title.reqdateto_reg')}}</th>
<input type="datetime" name="dateto" value="{{ (request()->input('dateto',old('dateto'))?:'') }}">
...
<th style="color:red;"> {{__('title.visitno_reg')}}</th>
