...
<html>   
<head>    
<title> LabTech Software (Edit Group) </title>  
<style>   
Body {  
  font-family:  serif;  
...
@endif
<form action = "{{url('editgroups/'.$users[0]->group_id)}}" method = "post">
    {{ method_field('post') }}
    {{ csrf_field() }}
...
<table>
<tr>
<td>{{__('title.group_edit')}}</td>
<td>
<input type = 'text' name = 'group_name'
value = '{{$users[0]->group_name}}' required/> </td>
</tr>
<tr>
<td>{{__('title.report_name_group_edit')}}</td>
<td>
