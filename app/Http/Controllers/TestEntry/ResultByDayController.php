...
class ResultByDayController extends Controller
{
	...
	public function index(){
		...
		->select('Groups.group_name as group','Test_Entry.regkey','Subgroups.subgroup_name as subgroup','Patient_Reg.*','Test_Data.subgroup as subgroup_id')
